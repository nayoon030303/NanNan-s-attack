...
void BossC::Render()
{
	TextureElement* element = textureManager.getTexture(TEX_BOSS_C);
	RECT rc;
	D3DXVECTOR3 pos;
	D3DXVECTOR3 cen;
...
D3DXVECTOR2 BossC::getSize()
{
	return { BOSS_WIDTH, BOSS_HEIGHT };
}

D3DXVECTOR2 BossC::getPos()
{
	return { posX, posY };
}
